<%-- 
    Document   : user_list
    Created on : Sep 18, 2022, 4:49:24 PM
    Author     : Admin
--%>
  ...
  <body>
    <div class="mv-site">
      ...
      <section class="main-banner mv-wrap">
        <div data-image-src="${pageContext.request.contextPath}/images/background/demo_bg_1920x1680.png" class="mv-banner-style-1 mv-bg-overlay-dark overlay-0-85 mv-parallax">
          <div class="page-name mv-caption-style-6">
            <div class="container">
              <div class="mv-title-style-9"><span class="main">user list</span><img src="${pageContext.request.contextPath}/images/icon/icon_line_polygon_line.png" alt="icon" class="line"/></div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="mv-breadcrumb-style-1">
          <div class="container">
            <ul class="breadcrumb-1-list">
              ...
              <li><a href="product-grid-3.html">Admin</a></li>
              <li><a>User list</a></li>
            </ul>
          </div>
        </div>
                      ...
                      <div class="mv-col-wrapper item-inner-relative">
                        <div class="mv-col content-thumb">
                          <div class="thumb-inner">
                            <div class="thumb-img-wrapper mv-effect-relative"><a href="product-detail.html" title="RST Tractech Evo CE Glove"><img src="images/demo/demo_370x530.png" alt="demo" class="mv-effect-item"/></a><a href="product-detail.html" title="RST Tractech Evo CE Glove" class="mv-btn mv-btn-style-25 btn-readmore-plus hidden-xs"><span class="btn-inner"></span></a></div>
...
<img src="images/demo/demo_120x40.png" alt="demo" onclick="$(this).remove()" class="content-logo hidden-xs hidden-sm"/>
                        ...
                        <div class="mv-col content-main">
                          <div class="content-main-inner">
                            <div class="content-detail">
                              <div class="content-title"><a href="product-detail.html" title="RST Full Zipped Sweatshirt" class="mv-overflow-ellipsis">RST Tractech Evo CE Glove</a></div>
                              ...
                              <div class="content-desc hidden-xs hidden-sm">Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Nunc finibus sit amet ligula id gravida. Curabitur quis orci non leo varius dapibus in ornare tortor. Cum </div>

                              <div class="content-line hidden-xs hidden-sm"></div>
                            </div>

                            <div class="content-button mv-btn-group text-center">
                              <div class="group-inner">
                                <button type="button" class="mv-btn mv-btn-style-1 responsive-btn-1-type-1 btn-add-to-cart"><span class="btn-inner"><i class="btn-icon fa fa-cart-plus"></i><span class="btn-text">add to cart</span></span></button>
                                ...
                                <button type="button" class="mv-btn mv-btn-style-3 responsive-btn-3-type-1 btn-compare"><i class="btn-icon fa fa-signal"></i></button>
                              </div>
                            </div>
                          </div>
                        </div>
...
<!--                  <article class="col-xs-6 col-sm-4 col-md-12 item post">
                    <div class="item-inner mv-effect-translate-1 mv-box-shadow-gray-1">
                      <div class="mv-col-wrapper item-inner-relative">
                        <div class="mv-col content-thumb">
                          <div class="thumb-inner">
                            <div class="thumb-img-wrapper mv-effect-relative"><a href="product-detail.html" title="RST Tractech Evo CE Glove"><img src="${pageContext.request.contextPath}/images/demo/demo_370x530.png" alt="demo" class="mv-effect-item"/></a><a href="product-detail.html" title="RST Tractech Evo CE Glove" class="mv-btn mv-btn-style-25 btn-readmore-plus hidden-xs"><span class="btn-inner"></span></a></div>
                  ...
                  <article class="col-xs-6 col-sm-4 col-md-12 item post">
                    <div class="item-inner mv-effect-translate-1 mv-box-shadow-gray-1">
                      <div class="mv-col-wrapper item-inner-relative">
                        <div class="mv-col content-thumb">
                          <div class="thumb-inner">
                            <div class="thumb-img-wrapper mv-effect-relative"><a href="product-detail.html" title="RST Tractech Evo CE Glove">
                                    <img src="${pageContext.request.contextPath}/images/demo/demo_370x530.png" alt="demo" class="mv-effect-item"/>
                                </a><a href="product-detail.html" title="RST Tractech Evo CE Glove" class="mv-btn mv-btn-style-25 btn-readmore-plus hidden-xs">
                                    <span class="btn-inner"></span></a></div>
...
<!--                              <div class="content-price"><span class="new-price">$ 128.24</span><span class="old-price">$ 170.99</span></div>-->
                              <div class="content-desc hidden-xs hidden-sm">Introduction: ${item.getIntro()}</div>
                              <div class="content-desc hidden-xs hidden-sm">- Gender: ${item.getGender()}</div>
                              <div class="content-desc hidden-xs hidden-sm">- Date Of Birth: ${item.getDob()}</div>
...
<!--                  <div class="count-post mv-title-style-10"><span class="number">12</span> Products of <span class="number">5</span> Pages</div>-->
                  ...
                  <ul class="pagination">
                      <c:forEach var="item" items="${totalPage}">
                                      <li class = "${item == page ? 'active' : ''}"><a href="${pageContext.request.contextPath}/admin/user/list?page=${item}&keyword=${keyword}" >${item}</a></li>
                      </c:forEach>
            ...
            <!-- .mv-c-s-content-->
   <form method="GET" class="form-aside-search" action="${pageContext.request.contextPath}/admin/user/list">
            <div class="mv-c-s-sidebar col-xs-12 col-md-4 col-lg-3 hidden-xs hidden-sm">
              <div class="mv-c-s-sidebar-inner">
                <div class="mv-aside mv-aside-search">
                  ...
                  <div class="aside-body">
                      ...
                      <div class="mv-inputbox-icon right">
                          <input type="text" name="keyword" class="mv-inputbox mv-inputbox-style-2" value="${keyword}" style="border: 1px solid gray"/>
                ...
                <div class="mv-aside mv-aside-filter-by-price">
                  ...
                  <div class="aside-body">
                    <form method="GET" class="form-aside-filter-by-price" action="${pageContext.request.contextPath}/admin/user/list">
                      <div class="mv-slider-range">
                        <div class="slider-range-wrapper mv-slider-range-style-1">
                          <div class="slider-range"></div>
                        </div>
                        <div class="mv-dp-table align-middle">
                          <div class="mv-dp-table-cell view-values">Gender:</div>
                          <br><br><br>
                          <select name="gender" class="mv-dropdown-style-1" style="width: 200%;height:30px">
                                  <option value="ALL"  ${gender != null && !gender.equals("MALE") && !status.equals("FEMALE") && !status.equals("OTHER")? 'selected' :''}>ALL</option>
                          ...
                          <div class="mv-slider-range">
                        <div class="mv-dp-table align-middle">
                          <div class="mv-dp-table-cell view-values">Status:</div>
                          <br><br><br>
                          <select name="status" class="mv-dropdown-style-1" style="width: 134%;margin-left: -36px;height:30px">
                                  <option value="ALL" ${status != null && !status.equals("0") && !status.equals("1") ? 'selected' :''}>ALL</option>
                                  <option value="1" ${status != null && status.equals("1") ? 'selected' :''}>ACTIVE</option>
                                  <option value="0" ${status != null && status.equals("0") ? 'selected' :''}>DEACTIVE</option>
