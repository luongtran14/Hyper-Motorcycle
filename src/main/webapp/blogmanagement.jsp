<%-- Document : blogmanagement Created on : Oct 9, 2022, 9:43:01 PM Author : huyen --%>
									...
									<tbody>
										<c:forEach items="${Blog}" var="b">
											<tr>
												...
												<td>
													<a href="editblog" class="edit" data-toggle="modal"><i
															class="material-icons" data-toggle="tooltip"
															title="Edit">&#xE254;</i></a>
													<a href="deleteblog" class="delete" data-toggle="modal"><i
															class="material-icons" data-toggle="tooltip"
															title="Delete">&#xE872;</i></a>
												</td>
											</tr>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								<form method="post" action="addblog">
									<input name="uid" value="${id}" hidden="Hidden">
